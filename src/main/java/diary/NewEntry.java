...
public class NewEntry {
    ...
    private static final String TEST_TEXT = "Это тестовая запись.";
    ...
    public static void main(String[] args) {
        ...
        WebElement DiText = driver.findElement(By.id("DiText"));
        DiText.click();
        DiText.sendKeys(TEST_TEXT);
        driver.findElement(By.id("btn_save")).click();

        String testText = driver.findElement(By.xpath("//div[@class=\"dit\"]/div[2]")).getText();
        System.out.println("Текст сохранен: " + testText.equals(TEST_TEXT));
