...
public class CreateNewProjectPage extends BasePage {
    ...
    // Контактное лицо
    @Step(value = "Enter contact person")
    ...
    // Подразделение
    @Step(value = "Select business unit")
    ...
    // Куратор проекта
    @Step(value = "Select curator of project")
    ...
    @Step(value = "Select leader of project")
    ...
    @Step(value = "Select administrator of project")
    ...
    // Менеджер проекта
    @Step(value = "Select manager of project")
    ...
    // Сохранение проекта
    @Step(value = "Click 'save project' button")
