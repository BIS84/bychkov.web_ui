package CRM.model.pages.listener;

import CRM.model.pages.helpers.ScreenshotMaker;
...
public class CustomListener implements WebDriverEventListener {
    ...
    public void beforeClickOn(WebElement element, WebDriver webDriver) {
        String log = String.format("Befor click on element with tagname = %s, enabled = %s, is_displayed = %s ", element.getTagName(), element.isEnabled(), element.isDisplayed());
        logger.info(log);
    }
